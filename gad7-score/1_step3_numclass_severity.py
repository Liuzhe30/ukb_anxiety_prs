...
# full table
data = pd.read_csv('covariables/2_is_anxiety_severity.csv')
...
for i in range(len(data)):
    ...
    #print(data_new)
    data_new.to_csv('covariables/3_final_numclass_severity.csv', index=None, columns=columns)
...
# save
data_new.to_csv('covariables/3_final_numclass_severity.csv', index=None, columns=columns)
data_new.to_csv('covariables/covariates_severity.txt', index=None, columns=columns, sep=' ')